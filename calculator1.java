/**
 * The calculator1 class is a Java program that performs addition, subtraction, multiplication, and
 ...
 * 
 * @param operand_1 The first operand of the multiplication operation. It is a floating-point number.
...
float multiplication(float operand_1,float operand_2){
     ...
     */
    float divesion(float operand_1,float operand_2){
        return(operand_1/operand_2);
        }
        /**
         * The main function creates an instance of the calculator1 class and performs addition,
         * subtraction, multiplication, and division operations on two operands.
         */
        public static void main(String[] args) {
            ...
            float div_result=cal.divesion(operand_1, operand_2);
